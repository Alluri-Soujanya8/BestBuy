...
private static By eGiftCardPageHeader = By.xpath("//h1[text()='E-Gift Card']");
...
private static By sendDigitalCardButton = By.id("sendCard");   // Adjust ID as per actual DOM
private static By designPageHeader = By.xpath("//h1[contains(text()='Choose E-Gift Card Design')]");
