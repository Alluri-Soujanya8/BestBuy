...
public class UserPage {
	...
	private static By brand = By.xpath("//button[contains(text(), 'TVs by Brand')]");
	...
	public static boolean selectbrand()
	{
		boolean actResult = true;
		try 
		{
			...
			Reports.generateReport(driver, test, Status.PASS, "TV Brand is displayed");
