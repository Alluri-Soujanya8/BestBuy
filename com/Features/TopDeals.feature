...
@FirstScenario
Scenario: test Top Deals Functionality 
...
@SecondScenario	
Scenario: test Saved Items Functionality
...
@FourthScenario  
Scenario Outline: test Add to Cart Functionality with valid data
	...
	And should click on Laptops
	Then should display Laptop Deals
	And User Laptop Deals page should scroll to Featured deals
	And click Add to Cart for first Laptop <sheetNo> <rowNum>
	And click Add to Cart for second Laptop <sheetNo> <rowNum>
	And click on Cart
	Then verify Cart
...
@FifthScenario   
Scenario: Test Holiday Deals Functionality

	Given Top Deals functionality should be availble
	When i click on Top Deals link
	And should display Top Deals page
	And should click Shop now
